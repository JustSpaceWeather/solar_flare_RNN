...
def GRU_Att(p, file_config, detect_type, class_type: str) -> None:
    ...
    """
    detect(p, file_config, detect_type, class_type, 'GRU_attention', get_and_load_model)
    # detect_same(p, file_config, detect_type, class_type, 'GRU_attention', get_and_load_model)
