...
def BLSTM(p, file_config, detect_type, class_type: str) -> None:
    """
    :param p: 项目根目录地址
    ...
    """
    detect(p, file_config, detect_type, class_type, 'Bi_LSTM', get_and_load_model)
    # detect_same(p, file_config, detect_type, class_type, 'Bi_LSTM', get_and_load_model)
