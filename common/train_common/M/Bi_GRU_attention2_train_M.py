...
def Bi_GRU_attention2_M_train(p: str, file_config, train_type: str):
    """
    :param p: 根目录地址
        ...
        for i in range(10):
            ...
            for j in range(train_config.epoch):
                ...
                best_TSS = show_score_and_save_weights(  # 计算最好的TSS，并保存取得最好的TSS的权重
                    ...
                    filename=model_save_path + '/Bi_GRU_attention2_M_' + str(time_steps) + '_best_' + str(i) + '.h5'
                )
            ...
            save_loss(
                ...
                model_save_path + '/Bi_GRU_attention2_M_' + str(time_steps) + '_best_' + str(i) + '.jpg',
                is_new
            )
            is_new = False
