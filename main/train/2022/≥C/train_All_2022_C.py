...
Bi_LSTM_C_train(p, file_config, '2022')
Bi_LSTM_attention_C_train(p, file_config, '2022')
# Bi_LSTM_attention2_C_train(p, file_config, '2022')
Bi_GRU_C_train(p, file_config, '2022')
Bi_GRU_attention_C_train(p, file_config, '2022')
# Bi_GRU_attention2_C_train(p, file_config, '2022')
