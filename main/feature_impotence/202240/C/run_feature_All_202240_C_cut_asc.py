...
#     NN_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

feature_cut_list = []
for i in range(9):
    feature_cut_list.append(feature_importance['LSTM'][i])
    LSTM_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['LSTM_Att'][i])
#     LSTM_attention_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['LSTM_Att2'][i])
#     LSTM_attention2_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

feature_cut_list = []
for i in range(9):
    feature_cut_list.append(feature_importance['BLSTM'][i])
    Bi_LSTM_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['BLSTM_Att'][i])
#     Bi_LSTM_attention_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['BLSTM_Att2'][i])
#     Bi_LSTM_attention2_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['GRU'][i])
#     GRU_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['GRU_Att'][i])
#     GRU_attention_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['GRU_Att2'][i])
#     GRU_attention2_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['BGRU'][i])
#     Bi_GRU_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['BGRU_Att'][i])
#     Bi_GRU_attention_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')

# feature_cut_list = []
# for i in range(9):
#     feature_cut_list.append(feature_importance['BGRU_Att2'][i])
#     Bi_GRU_attention2_run(p, file_config, '202240', 'C', feature_cut_list, 'asc')
