...
if __name__ == '__main__':
    for time_steps in [120]:  # seed_config.time_steps_list:
        ...
        model_save_path = p + '/weights/2018/LSTM_best≥C/time_steps=' + str(time_steps)
        for i in range(10):
            ...
            for j in range(config.epoch):
                ...
                best_TSS = show_score_and_save_weights(  # 计算最好的TSS，并保存取得最好的TSS的权重
                    ...
                    filename=model_save_path + '/LSTM_C_' + str(time_steps) + '_best_' + str(i) + '.h5'
                )
            ...
            save_loss(
                ...
                model_save_path + '/LSTM_C_' + str(time_steps) + '_best_' + str(i) + '.jpg',
                is_new
            )
            is_new = False
