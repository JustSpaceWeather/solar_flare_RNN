...
if __name__ == '__main__':
    for time_steps in config.time_steps_list:
        ...
        model_save_path = p + '/weights/TVT/Bi_LSTM_attention_best≥C/time_steps=' + str(time_steps)
        for i in range(10):
            ...
            show_loss(
                ...
                file_path=model_save_path + '/Bi_LSTM_attention_M_' + str(time_steps) + '_best_' + str(i) + '.jpg'
            )
