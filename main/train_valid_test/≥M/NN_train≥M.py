...
if __name__ == '__main__':
    model_save_path = p + '/weights/TVT/NN_best≥M_time_steps=' + str(time_steps)
    for i in range(10):
        ...
        for j in range(config.epoch):
            ...
            print('======================================')
        show_loss(loss_list, val_loss_list, config.epoch, file_path=model_save_path + '/NN_M_best_' + str(i) + '.jpg')
