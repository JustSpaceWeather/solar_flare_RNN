...
if __name__ == '__main__':
    for time_steps in config.time_steps_list:
        ...
        model_save_path = p + '/weights/2022/Bi_LSTM_best≥M/time_steps=' + str(time_steps)
        for i in range(10):
            ...
            model = get_Bi_LSTM_model(time_steps=time_steps, learning_rate=config.learning_rate,
