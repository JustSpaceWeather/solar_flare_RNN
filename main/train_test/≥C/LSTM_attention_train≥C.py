...
if __name__ == '__main__':
    for time_steps in time_steps_list:
        ...
        for i in range(10):
            ...
            model = get_LSTM_attention_model(time_steps=time_steps, learning_rate=learning_rate,
            ...
            for j in range(epoch):
                ...
                best_TSS = show_score_and_save_weights(  # 计算最好的TSS，并保存取得最好的TSS的权重
                    ...
                    filename=each_model_save_path + '/LSTM_attention_C_' + str(time_steps) + '_best_' + str(i) + '.h5'
                )
                print('======================================')
